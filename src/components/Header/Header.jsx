        ...
        <div className="nav">
          ...
          {isOpen && <div className='burger-list'>
            <ul onClick={() => setIsOpen(!isOpen)}>
              <li><NavLink to="/" style={{ display: "block", padding: '8px' }}>Accueil</NavLink></li>
              <li><NavLink to="/todolists" style={{ display: "block", padding: '8px' }}>Vos listes</NavLink></li>
              <li><NavLink to="/todolist/ajouter" style={{ display: "block", padding: '8px' }}>Créer une nouvelle liste</NavLink></li>
            </ul>
          </div>}
      {!loading &&
        <div className="login">
